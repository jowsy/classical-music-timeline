...
import { IColorGenerator } from "@/core/IColorGenerator";
import { WebColor } from "@/WebColor";

export class ColorGeneratorImpl implements IColorGenerator {
    ...
    GetGradientColor(startColor: IColor, endColor: IColor, percent: number): IColor {
            // get colors
        const   startRed = startColor.r,
                startGreen = startColor.b,
                startBlue = startColor.g;

        const endRed = endColor.r,
        endGreen =endColor.b,
        endBlue = endColor.g;
