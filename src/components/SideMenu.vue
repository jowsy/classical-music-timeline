        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <div>
                    ...
                    <vue-slider :tooltip="'none'" v-bind:min="session.timeExtents.min"
                        v-bind:max="session.timeExtents.max" v-model="session.timeExtents.value"
        ...
        <ul class="nav flex-column">
            <li class="nav-item" v-for="parameter in getFilterableParameterDefinitions()" v-bind:key="parameter.id">
                <div class="justify-content-between d-flex">
                    <div class="form-check form-switch" data-bs-toggle="collapse"
                        v-bind:href="'#'+parameter.name+'List'" role="button" aria-expanded="false"
            ...
            <li class="list-group-item" v-for="str in groupByParameter(parameter)" v-bind:key="str">
                <input type="checkbox" class="form-check-input"
                    v-on:change="applyParameterFilter($event, parameter.id, parameter.name, str)"> {{str}}
            </li>
    </div>
    </div>
    </li>
